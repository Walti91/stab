...
public class Generator {
	...
	private static void createEnrollment2(Storage storage) throws ParseException {
		...
		graduationDate.addDate(inputFormat.parse("11.01.2016 12:00"));
		graduationDate.addDate(inputFormat.parse("12.01.2016 12:00"));
		graduationDate.addDate(inputFormat.parse("13.01.2016 12:00"));
		graduationDate.addDate(inputFormat.parse("14.01.2016 12:00"));
		Commission commission = modelFactory.createCommission();
		commission.setDate(inputFormat.parse("13.01.2016 12:00"));
		...
		graduationDate.addDate(inputFormat.parse("01.06.2015 12:00"));
		graduationDate.addDate(inputFormat.parse("02.06.2015 12:00"));
		graduationDate.addDate(inputFormat.parse("03.06.2015 12:00"));
		graduationDate.addDate(inputFormat.parse("04.06.2015 12:00"));
